...
class DeprecatedBallerinaSensor implements Sensor {
    ...
    public DeprecatedBallerinaSensor(CheckFactory checkFactory, FileLinesContextFactory fileLinesContextFactory, NoSonarFilter noSonarFilter, BallerinaLanguage language){
